...
export default function HairShop() {
  ...
  return (
    <>
      <Head>
        <title>Hair Shop || WigsCastle Landing Page</title>
      </Head>
      ...
      <main className="mt-4">
        <div className="container">
          ...
          <h1 className="title">Human Hair Wigs</h1>
              ...
              <div className="col-md-9">
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    >
                      <option value="default1" selected>
                        Popularity
                      </option>
                      <option value="option2">Just Added</option>
                      <option value="option3">Best Seller</option>
